...
<ul>
    ...
    <%
          String key=(String)pageContext.findAttribute("recaptcha_public_key");
          String key2=(String)pageContext.findAttribute("recaptcha_private_key");
          ReCaptcha c = ReCaptchaFactory.newReCaptcha(key, key2, false);
          out.print(c.createRecaptchaHtml("Wrong captcha", null));
    %>
